...
// The data set consists of 3 scearios which have the same task ids, names, study time, difficulty. importance and type
// but different number of tasks and deadline 

//  scenario A has the total time availability of 15 hrs and required study time of 21 hours (ratio = 21/15 = 1.4)
Task tasksA[] = {
...
// since the dealines are not very close, they are less urgent and are compatible with ranked based sorting


//scenario b has the total time availability of 10 hrs and required study time of 33 hours (ratio = 33/10 = 3.3)
Task tasksB[] = {
    {"T1",  "Revise Dynamic Programming", 3, 5, 2, 4, "Lecture"},
    {"T2",  "Complete Graph Tutorial",    2, 4, 3, 3, "Tutorial"},
...
Task tasksC[] = {
    ...
    {"T7",  "Python Group Project",       4, 3, 1, 5, "Assignment"},
    {"T8",  "Review Sorting Algorithms",  2, 5, 2, 4, "Lecture"},
    {"T10", "Prepare for Final Exam",     3, 5, 1, 5, "Exam"}  // studyTime reduced to 3 for scenario fit
};
int totalTasksC    = 6;
int availableHrsC  = 8;
// since the available time is less and deadlines are extree=mely tight, we have to use greedy startegy 
